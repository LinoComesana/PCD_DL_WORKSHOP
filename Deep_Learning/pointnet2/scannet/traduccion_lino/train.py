...
# sesion:
nombre_sesion = raw_input('Introduce un nombre para la sesion: ')
...
if not LINO:
    ...
    DATASET_PATH = '/home/lino/Documentos/programas_pruebas_varias/segmentacion_python/segmentacion_bosques/aumentacion_de_datos/Nubes_artificiales_generadas/Nubes_artificiales_personalizadas_2022_5_19___12:47:7'
    TRAIN_DATA_PATH = DATASET_PATH +'/TRAIN'
    TEST_DATA_PATH = DATASET_PATH +'/TEST'    
    PREDICT_DATA_PATH = '/home/lino/Documentos/TESTEO_ZEBGO_Nubes/NDP_zebRevo_xures_julio_21/prueba_2/laz_format'
...
def eval_one_epoch_PREDICCION_NUBE_REAL(sess, ops, test_writer,epoch,RUTA_LOG_ABSOLUTA):
    ...
    for ll in range(NUMERO_NUBES_PREDICCION):
        ...
        PREDICT_DATASET = scannet_dataset.ScannetDataset(root=PREDICT_DATA_PATH, npoints=NUM_POINT, split='prediccion',LINO=LINO,NUM_CLASSES=NUM_CLASSES,downsampleamos=False,contador_dataset=0,tamanho_batch = 1,tipo_de_nubes=tipo_de_nubes,archivo='2021-07-05_10-57-22_9pct_time.npy')
        # contador_dataset_testeo += BATCH_SIZE
