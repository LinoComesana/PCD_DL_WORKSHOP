...
RUTA_LOG_ABSOLUTA = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_nacional_Santarem'

##RUTA_LOG_ABSOLUTA = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_prueba_Santarem_2'
...
archivo = 'nacional_Santarem_accuracies_y_losses_one_epoch.txt'
##archivo = 'prueba_Santarem_2_accuracies_y_losses_one_epoch.txt'
...
indices_barreras_quitamiedos = np.where(pred_val == 5)
# indices_barrera_quitamiedos_2 = np.where(pred_val == 6)
indices_arcen = np.where(pred_val == 6)
indices_mediana = np.where(pred_val == 7)
# indices_barrera_jersey = np.where(pred_val == 9)
indices_berma = np.where(pred_val == 8)
'''
...
indices_carretera = np.where(pred_val == 6)
...
nube_artificial_clasificada = o3d.geometry.PointCloud()
nube_artificial_clasificada.points = o3d.utility.Vector3dVector(aug_data)
nube_artificial_clasificada.colors = o3d.utility.Vector3dVector(colores)
o3d.visualization.draw(nube_artificial_clasificada)
o3d.io.write_point_cloud("nube_artificial_clasificada.pcd", nube_artificial_clasificada)



# epoca_nube_real = 75 # Esta salió medio guay
epoca_nube_real = 95
...
nube_real_clasificada = o3d.geometry.PointCloud()
nube_real_clasificada.points = o3d.utility.Vector3dVector(aug_data)
nube_real_clasificada.colors = o3d.utility.Vector3dVector(colores)
o3d.visualization.draw(nube_real_clasificada)
o3d.io.write_point_cloud("nube_real_clasificada_epoca_%i.pcd"%epoca_nube_real, nube_real_clasificada)
