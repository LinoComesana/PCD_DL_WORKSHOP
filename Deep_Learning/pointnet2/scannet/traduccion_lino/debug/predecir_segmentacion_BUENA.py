...
MODEL_PATH = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_prueba_julio_2_ancho_celda_5'

# Cargamos el nombre del modelo ya entrenado:
nombre_del_modelo = 'best_model_epoch_135.ckpt'
...
if not LINO:
    ...
    nombre_archivo_a_segmentar = 'L055-1-M01-S2-C1_s_RGB_REDNAP_AJ_RECORTADA.npy'
