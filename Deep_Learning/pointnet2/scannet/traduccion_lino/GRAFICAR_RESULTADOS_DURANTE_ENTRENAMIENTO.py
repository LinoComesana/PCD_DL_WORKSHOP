...
# ESTO ES PARA CORRER EN LOCAL (NO EN EL CESGA)!!!
...
for EPOCA in range(NUMERO_DE_EPOCAS_GLOBAL):
    ...
    RUTA_LOG_ABSOLUTA = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_autopista_5_capas_seccion_transversal'
    ...
    archivo = 'prueba_autopista_2_accuracies_y_losses_one_epoch.txt'
