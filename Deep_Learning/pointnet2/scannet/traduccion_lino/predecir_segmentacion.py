...
# -*- coding: utf-8 -*-
"""
Created on Fri May  6 10:17:14 2022
...
NUMERO_PUNTOS_VOXEL_LINO = 10000
...
MODEL_PATH = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_vamaverrrr'

# Cargamos el nombre del modelo ya entrenado:
nombre_del_modelo = 'best_model_epoch_010.ckpt'
...
if PREDICCION:
    ...
    MODEL = importlib.import_module(FLAGS.model) # import network module
    MODEL_FILE = os.path.join(BASE_DIR, FLAGS.model+'.py')
    LOG_DIR = '/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_pruuebisima'





PREDICT_DATA_PATH = '/home/lino/Documentos/programas_pruebas_varias/segmentacion_python/segmentacion_bosques/aumentacion_de_datos/Nubes_artificiales_generadas/Nubes_artificiales_personalizadas_2022_1_14___12:13:9/Nube_artificial_0_solo_bosque'    
PREDICT_DATASET = scannet_dataset.ScannetDataset(root=PREDICT_DATA_PATH, npoints=NUM_POINT, split='prediccion',LINO=LINO)
# PREDICT_DATASET_WHOLE_SCENE = scannet_dataset.ScannetDatasetWholeScene(root=PREDICT_DATA_PATH, npoints=NUM_POINT, split='prediccion',LINO=LINO)
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            # train_one_epoch(sess, ops, train_writer,RUTA_LOG_ABSOLUTA)
...
def get_batch_wdp(dataset, idxs, start_idx, end_idx):
    ...
    for i in range(bsize):
        ...
        # print(dataset)
        # print()
        # print(dataset[idxs[i+start_idx]])
        # print()
...
def eval_one_epoch(sess, ops, test_writer,epoch,RUTA_LOG_ABSOLUTA):
    ...
    for batch_idx in range(num_batches):
        ...
        # import os
        # os.chdir('/home/lino/Documentos/programas_pruebas_varias/PointNet/pointnet2/log_nueva_prediccion')
