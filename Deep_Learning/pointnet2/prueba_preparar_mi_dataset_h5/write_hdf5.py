...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 21 10:04:18 2022
...
def write_tensor_label_hdf5(mat_filelist, volume_size, pad_size):
    ...
    # =============================================================================
    # Specify what data and label to write, CHANGE this according to your needs...
    ...
    for k in range(N):
        # Cambiar esta línea por un load .npy donde se cargue un numpy array:
        # mat = sio.loadmat(tensor_filenames[k])
        mat = np.load(tensor_filenames[k])
        d = mat[mat.keys()[0]]
        l = labels[k]
